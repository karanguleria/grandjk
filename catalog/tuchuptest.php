...
if ($colour_id) {
    ...
    //get categories
    $categories_sql = 'SELECT * FROM categories where `state`= 3';
    ...
    <table border="1" width="100%">
        ...
        if ($categories) {
            ...
            foreach ($categories as $category) {
                ...
                ?>	
                <tr>														
                    <td colspan="5" id="<?php echo trim($category['category']) ?>">
